...
class Chrome:
    def __init__(self, remote_debugging_port: Optional[int], user_data_dir: Optional[str] = None):
        self.user_data_dir = '.chrome_user_data/' + user_data_dir
        self.remote_debugging_port = remote_debugging_port
        self.process = ChromeProcess(remote_debugging_port, self.user_data_dir)
    ...
    async def _close(self):
        ...
        result = await client.send("Browser.close")
        print(result)
